(function() {
    tinymce.PluginManager.add('agilecrm_newsletter_button', function( editor, url ) {
        editor.addButton( 'agilecrm_newsletter_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_newsletter id="' + e.data.form+ '"]');
                    }
                });
                }
            });
